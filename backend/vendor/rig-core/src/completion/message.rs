...
impl MimeType for DocumentMediaType {
    fn from_mime_type(mime_type: &str) -> Option<Self> {
        match mime_type {
            ...
            "text/html" | "application/xhtml+xml" => Some(DocumentMediaType::HTML),
            "text/css" => Some(DocumentMediaType::CSS),
            "text/md" | "text/markdown" | "text/x-markdown" => {
                Some(DocumentMediaType::MARKDOWN)
            }
            "text/csv" | "application/csv" => Some(DocumentMediaType::CSV),
            "text/tsv" => Some(DocumentMediaType::TSV),
            "application/json" | "application/json5" | "application/x-json5" => {
                Some(DocumentMediaType::JSON)
            }
            "application/yaml" | "application/x-yaml" | "text/x-yaml" => {
                Some(DocumentMediaType::YAML)
            }
            "text/xml" | "application/xml" => Some(DocumentMediaType::XML),
            "application/javascript" | "text/javascript" | "application/x-javascript"
            | "text/x-javascript" | "text/jsx" => Some(DocumentMediaType::Javascript),
            "application/typescript" | "text/x-typescript" | "text/tsx" => {
                Some(DocumentMediaType::Typescript)
            }
            "application/x-python" | "text/x-python" | "text/x-script.python" => {
            ...
            | "text/x-iif"
            | "application/x-iif" => Some(DocumentMediaType::Excel),
            "application/vnd.openxmlformats-officedocument.wordprocessingml.document"
            | "application/msword"
            | "application/vnd.google-apps.document" => Some(DocumentMediaType::Word),
            "application/vnd.openxmlformats-officedocument.presentationml.presentation"
            | "application/vnd.ms-powerpoint"
            | "application/vnd.google-apps.presentation" => Some(DocumentMediaType::Presentation),
            "application/vnd.oasis.opendocument.text" => Some(DocumentMediaType::OpenDocumentText),
            "application/vnd.apple.pages" => Some(DocumentMediaType::Pages),
            "application/vnd.apple.keynote" => Some(DocumentMediaType::Keynote),
            "text/calendar" => Some(DocumentMediaType::Calendar),
            "message/rfc822" => Some(DocumentMediaType::Email),
            "text/x-vcard" | "text/vcard" => Some(DocumentMediaType::VCard),
            "text/srt" | "application/x-subrip" | "text/x-subrip" => Some(DocumentMediaType::SRT),
            "text/vtt" => Some(DocumentMediaType::VTT),
            "application/toml" | "application/x-toml" | "text/x-toml" => {
                Some(DocumentMediaType::TOML)
            }
            "application/x-sql" | "text/x-sql" => Some(DocumentMediaType::SQL),
            "text/x-shellscript" | "text/x-sh" | "text/x-bash" | "application/x-bash"
            | "text/x-zsh" => Some(DocumentMediaType::Shell),
            "text/x-rust" | "application/x-rust" => Some(DocumentMediaType::Rust),
            "text/x-go" | "text/x-golang" => Some(DocumentMediaType::Go),
            "text/x-java" => Some(DocumentMediaType::Java),
            "text/x-php" | "application/x-php" | "application/x-httpd-php" => {
                Some(DocumentMediaType::Php)
            }
            "text/x-ruby" => Some(DocumentMediaType::Ruby),
            "text/x-c" => Some(DocumentMediaType::C),
            "text/x-c++" => Some(DocumentMediaType::Cpp),
            "text/x-csharp" => Some(DocumentMediaType::CSharp),
            "text/x-kotlin" => Some(DocumentMediaType::Kotlin),
            "text/x-swift" => Some(DocumentMediaType::Swift),
            "text/x-lua" => Some(DocumentMediaType::Lua),
            "text/x-r" | "text/x-R" => Some(DocumentMediaType::R),
            "text/x-perl" => Some(DocumentMediaType::Perl),
            "text/x-diff" | "text/x-patch" | "application/x-patch" => {
                Some(DocumentMediaType::Diff)
            }
            "text/x-protobuf" | "application/x-protobuf" => Some(DocumentMediaType::Protobuf),
            "application/graphql" | "application/x-graphql" | "text/x-graphql" => {
                Some(DocumentMediaType::Graphql)
            }
            "application/x-ndjson" => Some(DocumentMediaType::Ndjson),
            _ => None,
        }
    }
    ...
    fn to_mime_type(&self) -> &'static str {
        match self {
            ...
            DocumentMediaType::TSV => "text/tsv",
            DocumentMediaType::JSON => "application/json",
            DocumentMediaType::YAML => "application/yaml",
            ...
            DocumentMediaType::Typescript => "application/typescript",
            DocumentMediaType::Excel => {
                "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"
            }
            DocumentMediaType::Word => {
                "application/vnd.openxmlformats-officedocument.wordprocessingml.document"
            }
            DocumentMediaType::Presentation => {
                "application/vnd.openxmlformats-officedocument.presentationml.presentation"
            }
            DocumentMediaType::OpenDocumentText => "application/vnd.oasis.opendocument.text",
            DocumentMediaType::Pages => "application/vnd.apple.pages",
            DocumentMediaType::Keynote => "application/vnd.apple.keynote",
            DocumentMediaType::Calendar => "text/calendar",
            DocumentMediaType::Email => "message/rfc822",
            DocumentMediaType::VCard => "text/x-vcard",
            DocumentMediaType::SRT => "text/srt",
            DocumentMediaType::VTT => "text/vtt",
            DocumentMediaType::TOML => "application/toml",
            DocumentMediaType::SQL => "application/x-sql",
            DocumentMediaType::Shell => "text/x-shellscript",
            DocumentMediaType::Rust => "text/x-rust",
            DocumentMediaType::Go => "text/x-go",
            DocumentMediaType::Java => "text/x-java",
            DocumentMediaType::Php => "text/x-php",
            DocumentMediaType::Ruby => "text/x-ruby",
            DocumentMediaType::C => "text/x-c",
            DocumentMediaType::Cpp => "text/x-c++",
            DocumentMediaType::CSharp => "text/x-csharp",
            DocumentMediaType::Kotlin => "text/x-kotlin",
            DocumentMediaType::Swift => "text/x-swift",
            DocumentMediaType::Lua => "text/x-lua",
            DocumentMediaType::R => "text/x-r",
            DocumentMediaType::Perl => "text/x-perl",
            DocumentMediaType::Diff => "text/x-diff",
            DocumentMediaType::Protobuf => "application/x-protobuf",
            DocumentMediaType::Graphql => "application/graphql",
            DocumentMediaType::Ndjson => "application/x-ndjson",
        }
    }
}
...
impl MimeType for AudioMediaType {
    fn from_mime_type(mime_type: &str) -> Option<Self> {
        match mime_type {
            ...
            "video/avi" => Some(AudioMediaType::AVI),
            "video/mp4" => Some(AudioMediaType::MP4),
            "video/mpeg" => Some(AudioMediaType::MPEG),
            "video/mov" => Some(AudioMediaType::MOV),
            "video/webm" => Some(AudioMediaType::WEBM),
    ...
    fn to_mime_type(&self) -> &'static str {
        match self {
            ...
            AudioMediaType::AVI => "video/avi",
            AudioMediaType::MP4 => "video/mp4",
            AudioMediaType::MPEG => "video/mpeg",
            AudioMediaType::MOV => "video/mov",
            AudioMediaType::WEBM => "video/webm",
