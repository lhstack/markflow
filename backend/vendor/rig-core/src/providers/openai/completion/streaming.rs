...
struct StreamingDelta {
    ...
    reasoning_content: Option<String>, // Non-standard: reasoning_content or Sensenova's reasoning
    ...
    Ext: crate::client::Provider + Clone + 'static,
{
    ...
    ) -> Result<streaming::StreamingCompletionResponse<StreamingCompletionResponse>, CompletionError>
    {
        ...
        {
            let request_json = serde_json::to_string_pretty(&request_as_json)?;
            tracing::info!("[openai_chat_stream_request] {request_json}");
            let _ = std::fs::write("rig_openai_chat_stream_request.json", request_json);
        }
