...
function getMarkdownEditorRuntimeTool() {
  ...
  return {
    ...
    usage_notes: [
      ...
      'For empty-document drafting and end-of-document continuation writes, use markflow.appendCurrentDocumentContent via execute_browser_javascript.',
      'For full document replacement, use markflow.replaceCurrentDocumentContent via execute_browser_javascript.',
      'For partial edits, prefer rewriteDocumentSection, replaceDocumentBlock, replaceDocumentBlocks, or swapDocumentSections.',
